...
void Respawn() {
    ...
    std::uniform_real_distribution<double> dis_init(-10, 10);
...
// double global_x_tar = 0.0; // target x based global frame
// double global_y_tar = 0.0; // target y based global frame

// double global_x = 0; // x based global frame
// double global_y = 0; // y based global frame

// double world_x = 0; // x based world frame
// double world_y = 0; // y based world frame
// double world_z = 0; // z based world frame

// double world_x_init = 0; // initial x based world frame
// double world_y_init = 0; // initial y based world frame
...
//     global_x = cos(-yaw_init)*(world_x - world_x_init) - sin(-yaw_init)*(world_y - world_y_init); // x based global frame
//     global_y = sin(-yaw_init)*(world_x - world_x_init) + cos(-yaw_init)*(world_y - world_y_init); // y based global frame
// }
...
//         world_x_init = world_x;
//         world_y_init = world_y;

//         std_msgs::Float32MultiArray world_pos_init;
//         world_pos_init.data.push_back(world_x_init);
//         world_pos_init.data.push_back(world_y_init);
//         pub_randxy.publish(world_pos_init);
...
//     // global_x = cos(-yaw_init)*(world_x - x_init) - sin(-yaw_init)*(world_y - y_init);
//     // global_y = sin(-yaw_init)*(world_x - x_init) + cos(-yaw_init)*(world_y - y_init);
...
// // void WorldToGlobal(double world_x, double _world_y, double world_x_init, double _yaw_init, ) {
