...
//  std::string num_;
  //num_<<num;
  filePath_="/home/kch/Desktop/datasetgogo/num/su_ran.png";
...
//  nodeHandle_.param("file", filePath_, std::string("/home/kch/Desktop/dataset/nu /grid_map_image.png"));
  ...
  grid_map::GridMapRosConverter::toCvImage(map,"elevation", sensor_msgs::image_encodings::MONO16,-0.5,1, image);
